...
| `20260924202402_funktionskontakte_aktive_ereignisse.sql` | Zuständige Personen und Rufnummern in aktiven Ereignissen nachführen; bestehende aktive Verständigungsschritte einmalig ergänzen und Löschung verwendeter Funktionen verhindern |
| `20260924203548_profil_als_funktionskontakt.sql` | Aktive Portalbenutzer einschließlich Kommando direkt als Funktionskontakt und Vertretung auswählbar; Profilrufnummern bleiben zentral gepflegt und erscheinen in Verständigungen |
| `20260924213000_namenslisten_operativ_freigeben.sql` | Evakuierungs- und Unterbringungslisten aus ZMR-Daten für Zentrale sowie diensthabende Einsatzkräfte wieder beschreibbar; ersetzt die versehentliche Beschränkung auf reine Hauslisten |
