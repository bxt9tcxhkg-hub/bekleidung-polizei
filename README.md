...
| `20260902_app_errors.sql` | `app_errors` (In-house Laufzeitfehler, Admin-Lesen, kein Drittanbieter) |
...
1. **Migrationen anwenden** (`20260501`, `20260830`, `20260901`, `20260902`) auf das Supabase-Projekt.
