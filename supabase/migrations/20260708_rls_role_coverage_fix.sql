-- Rollenabdeckung der RLS-Policies reparieren (bereits angewendet am 2026-07-08):
-- Sachbearbeiter konnte nichts verwalten (Policies prüften nur 'admin'),
-- die Rolle 'genehmiger' fehlte überall (nur 'approver' wurde geprüft),
-- Benutzer konnten ihr eigenes Profil nicht ändern (Policy fehlte komplett).
