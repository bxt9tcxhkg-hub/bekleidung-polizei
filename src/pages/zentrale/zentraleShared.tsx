...
export function IncidentCards({ visibleIncidents, lageByIncidentId, baustellen, canManage, canOperateZentrale, openLageForIncident, completeIncident, deleteIncident }: {
