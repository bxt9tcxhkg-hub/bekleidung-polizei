...
export default function ZentralePersonenhinweise() {
  ...
  // Diensthabende Zentralisten (Zentrale oder Innendienst) dürfen
  // Personenhinweise auch ohne eigene Sachbearbeiter/Genehmiger-Rolle
  // erfassen und endgültig löschen (RLS erzwingt das zusätzlich).
