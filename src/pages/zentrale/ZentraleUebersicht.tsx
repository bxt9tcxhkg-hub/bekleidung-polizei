...
export default function ZentraleUebersicht() {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <section><h2 className="font-bold text-gray-900 flex items-center gap-2 mb-3"><MapPin className="w-4 h-4 text-blue-700" /> Aktive Einsätze – Gemeindegebiet Dornbirn</h2><LeafletMap height={420} markers={ctx.openIncidentMarkers} lines={[...ctx.baustellenLines, ...ctx.sperrenLines]} fitLines={false} /></section>
    </div>
