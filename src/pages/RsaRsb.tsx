...
export default function RsaRsb() {
  ...
  return <PortalChrome wide>
    ...
    <div className="mb-5"><p className="text-xs font-bold uppercase tracking-wider text-red-700">Operativer Bereich</p><h1 className="text-2xl font-bold text-gray-900 mt-1">RSa/RSb & Vernehmungen</h1><p className="text-sm text-gray-500 mt-1">Schwer erreichbare Personen – unabhängig vom heutigen Dienst erfassbar.</p></div>
    <MailDeliveries />
  </PortalChrome>
}
