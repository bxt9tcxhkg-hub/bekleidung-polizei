...
export default function KontrollauftraegePage() {
  ...
  return <div>
    ...
    {ctx.showForm ? <AuftragModal auftrag={ctx.auftrag} setAuftrag={ctx.setAuftrag} editing={ctx.editing} saving={ctx.saving} error={ctx.formError} close={ctx.close} save={ctx.save} remove={ctx.remove} /> : null}
  </div>
}
