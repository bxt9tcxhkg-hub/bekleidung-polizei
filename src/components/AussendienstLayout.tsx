...
import { LayoutGrid, LogOut, Menu, Shield, X } from 'lucide-react'
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-30 w-60 bg-blue-950 flex flex-col transition-transform duration-200 ${
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-blue-900">
          ...
          <div className="min-w-0">
            ...
            <p className="text-blue-300 text-xs">Außendienst / Streife</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="font-semibold text-gray-900 text-sm truncate">Außendienst</span>
          </div>
          {sidebarOpen ? (
